    ...
    <Card>
      ...
      <CardContent className="space-y-4">
        ...
        <div className="rounded-lg border border-dashed px-4 py-3 text-xs text-muted-foreground space-y-0.5">
          ...
          <p>
            Contoh: skor 4+3+4+3+3 = 17 → 17/5 = 3,4 → 3,4 × 25 ={" "}
    ...
    <Card>
      ...
      <CardContent className="space-y-4">
        ...
        <div className="rounded-lg border border-dashed px-4 py-3 text-xs text-muted-foreground space-y-0.5">
          ...
          <p>
            Contoh: skor 3+2 = 5 → 5/2 = 2,5 → 2,5/3 × 100 ={" "}
            <strong className="text-foreground">83,3</strong>
          </p>
        </div>
      </CardContent>
    </Card>
